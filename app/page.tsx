...
export default async function Page() {
  ...
  return (
    <div className="min-h-dvh flex items-center max-sm:px-4 justify-center bg-gray-50">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-10 w-full max-w-md space-y-6 text-center">
       ...
       <div className="flex items-center justify-center">
        ...
        >
          <button
            type="submit"
            className="w-full flex items-center  justify-center gap-3 px-4 py-3 border border-gray-200 rounded-xl hover:bg-gray-50 transition-colors text-sm font-medium"
          >
